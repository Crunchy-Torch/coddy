...
{% if CODDY_SECURITY_JWT_SESSION_TIMEOUT_MIN is defined %}org.crunchytorch.coddy.security.jwt.session_timeout_minute={{CODDY_SECURITY_JWT_SESSION_TIMEOUT_MIN}}{% endif %}
